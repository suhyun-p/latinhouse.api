...
insert into class_main (title, status, genre, region, instructor_no_1, instructor_no_2, start_date, end_date, date_desc, start_time, end_time, time_desc, location, price)
values ('소수 집중 티칭 - 스타일링 안무반 A', 'S2', 'B', 'HD', 3, null, '2021-01-23', '2021-02-20', '총 5주, 매주 토요일', '17:00', '18:30', '90분', '댄싱아일랜드', 120000);
